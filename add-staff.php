...
<i class="fa fa-times-circle"></i> '.$er.'</div>';}elseif(isset($send)){echo '<div class="alert alert-success text-center text-uppercase" style="padding:3px !important;"><i class="fa fa-check-circle"></i> '.$send.'</div>'.'<script type="text/javascript">jQuery(document).ready(function(e){setTimeout(function(){window.location.href="add-staff";},2000);});</script>';} 
?>                                
</div> 
...
<select class="form-control" name="grade" title="Select Grade Level" style="cursor:pointer;">
    <?php echo $utility->DropdownLevel(1,17); ?>
  </select>
</div>
